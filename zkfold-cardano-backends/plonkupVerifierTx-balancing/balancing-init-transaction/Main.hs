...
main = do
  ...
  BL.writeFile (path </> "test-data" </> "plonkupVerifierTx-contract-data.json") $ encode contract
  ...
  savePlutus (assetsPath </> "plonkupVerifierTx.plutus") $ plonkupVerifierTxCompiled setup
